...
public class SwerveSubsystem extends SubsystemBase {
    ...
    AprilTagFieldLayout aprilTagFieldLayout = AprilTagFieldLayout.loadField(AprilTagFields.k2026RebuiltAndymark);
    ...
    public void periodic(){
        ...
        SmartDashboard.putNumber("CURRENT TARGET POSE X:", getEstimatedPose().getX());
        SmartDashboard.putNumber("CURRENT TARGET POSE Y:", getEstimatedPose().getY());
        SmartDashboard.putNumber("CURRENT SWERVE POSE ROTATION:", getEstimatedPose().getRotation().getDegrees());
